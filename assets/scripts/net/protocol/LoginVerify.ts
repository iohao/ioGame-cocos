...
export function decodeLoginVerify(binary: Uint8Array): LoginVerify {
  return _decodeLoginVerify(wrapByteBuffer(binary));
}

function _decodeLoginVerify(bb: ByteBuffer): LoginVerify {
  let message: LoginVerify = {} as any;
  ...
  end_of_message: while (!isAtEnd(bb)) {
    ...
    switch (tag >>> 3) {
      ...
      // optional string jwt = 2;
      case 2: {
        message.jwt = readString(bb, readVarint32(bb));
        break;
      }
